...
async def pause(client: Client, message: Message):
    ...
    await message.reply_text("**Sangram -** ⏸ Paused.")
...
async def resume(client: Client, message: Message):
    ...
    await message.reply_text("**Sangram -** ▶️ Resumed.")
...
async def stop(client: Client, message: Message):
    ...
    await message.reply_text("**Sangram -** ⏹ Stopped streaming.")
...
async def skip(client: Client, message: Message):
    ...
    await message.reply_text("**Sangram -** ⏩ Skipped the current song.")
...
async def admincache(client, message: Message):
    ...
    await message.reply_text("**Sangram -** ❇️ Admin cache refreshed!")
